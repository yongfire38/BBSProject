...
public class DirectoryPathManager {
	...
	public static File getUniqueFile(String imageBaseDir, String subDir, String fileName) {
		...
		System.out.println("@@@@@ Initial full path: " + fileStorePath + EgovWebUtil.filePathBlackList(imageBaseDir + subDir) + FilenameUtils.getName(fileName));
		File file = new File(fileStorePath + EgovWebUtil.filePathBlackList(imageBaseDir + subDir) + FilenameUtils.getName(fileName));
		System.out.println("@@@@@ Initial file path: " + file.getAbsolutePath());
		...
		do {
			...
			System.out.println("@@@@@ Trying unique file name: " + tmpFile.getAbsolutePath());
		} while (tmpFile.exists());
		System.out.println("@@@@@ Unique file found: " + tmpFile.getAbsolutePath());
		return tmpFile;
	}
