...
public class BoardMaster implements Serializable {
    ...
    /** 게시판 소개 */
    @EgovNullCheck(message = "{comCopBbs.boardMasterVO.regist.bbsIntrcn}{common.required.msg}")
    @Size(max = 2000, message = "{comCopBbs.boardMasterVO.regist.bbsIntrcn}{common.required.msg}")
    private String bbsIntrcn = "";
    
    /** 게시판 명 */
    @EgovNullCheck(message = "{comCopBbs.boardMasterVO.regist.bbsNm}{common.required.msg}")
    @Size(max = 120, message = "{comCopBbs.boardMasterVO.regist.bbsNm}{common.required.msg}")
    private String bbsNm = "";
    
    /** 게시판 유형코드 */
    @EgovNullCheck(message = "{comCopBbs.boardMasterVO.regist.bbsTyCode}{common.required.msg}")
    private String bbsTyCode = "";
    
    /** 파일첨부가능여부 */
    @EgovNullCheck(message = "{comCopBbs.boardMasterVO.regist.fileAtchPosblAt}{common.required.msg}")
    ...
    /** 사용여부 */
    @EgovNullCheck(message = "{comCopBbs.boardMasterVO.regist.useAt}{common.required.msg}")
